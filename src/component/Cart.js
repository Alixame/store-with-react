...
const Cart = () => {
  return (
    <>
        ...
        <div className="w-full container min-h-screen px-4 sm:px-8">
            <div className="pb-8">
                <button href='#' className="flex font-semibold text-indigo-600 text-sm mt-10 p-4">
            ...
            <div className="flex shadow-md">
                <div className="w-3/4 bg-white px-10">
                    ...
                    <div className="flex mt-10 mb-5">
                        ...
                        <h3 className="font-semibold text-center text-gray-600 text-xs uppercase w-1/5 text-center">Valor</h3>
